...
class TestOrphanPurge:
    ...
    def test_purge_orphans_returns_dict(self):
        ...
        with patch('orphan_purge.bpy') as mock_bpy, \
            ...
            mock_stats.return_value = {"meshes": 0, "materials": 0, "textures": 0,
                "images": 0, "cameras": 0, "lights": 0, "curves": 0,
                "armatures": 0, "actions": 0, "total": 0}
    ...
    def test_get_memory_report_returns_string(self):
        ...
        with patch('orphan_purge.bpy') as mock_bpy, \
            ...
            mock_stats.return_value = {"meshes": 0, "materials": 0, "textures": 0,
                "images": 0, "cameras": 0, "lights": 0, "curves": 0,
                "armatures": 0, "actions": 0, "total": 0}
            mock_usage.return_value = {"python_objects": 0, "python_materials": 0,
                "python_meshes": 0, "orphan_blocks": 0, "timestamp": "now"}
