...
class TestRealSandbox:
    ...
    def test_import(self):
        ...
        from infrastructure.security.sandbox_real import RealSandbox
    ...
    def test_isolation(self):
        ...
        result = s.execute("import os; os._exit(0)")
    ...
    def test_singleton(self):
        ...
        from infrastructure.security.sandbox_real import get_sandbox
        s1 = get_sandbox()
        s2 = get_sandbox()
        assert s1 is s2
