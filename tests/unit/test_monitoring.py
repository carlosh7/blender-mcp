...
class TestAlertManager:
    ...
    def test_alert_manager_import(self):
        from infrastructure.monitoring import AlertManager
        assert AlertManager is not None
    
    def test_check_alerts_normal(self):
        from infrastructure.monitoring import AlertManager, Metrics
...
class TestSingletons:
    ...
    def test_alert_manager_singleton(self):
        from infrastructure.monitoring import get_alert_manager
...
class TestConvenienceFunctions:
    ...
    def test_check_health(self):
        from infrastructure.monitoring import check_health
        status = check_health()
    ...
    def test_record_metric(self):
        from infrastructure.monitoring import record_metric, get_metrics
