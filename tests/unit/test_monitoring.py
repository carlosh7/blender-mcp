...
class TestHealthChecker:
    ...
    def test_health_checker_import(self):
        from mcp_ultra.infrastructure.monitoring import HealthChecker
...
class TestMetricsCollector:
    ...
    def test_metrics_collector_import(self):
        from mcp_ultra.infrastructure.monitoring import MetricsCollector
...
class TestAlertManager:
    ...
    def test_alert_manager_import(self):
        from mcp_ultra.infrastructure.monitoring import AlertManager

        assert AlertManager is not None

    def test_check_alerts_normal(self):
        from mcp_ultra.infrastructure.monitoring import AlertManager, Metrics
...
class TestSingletons:
    ...
    def test_health_checker_singleton(self):
        from mcp_ultra.infrastructure.monitoring import get_health_checker
    ...
    def test_metrics_collector_singleton(self):
        from mcp_ultra.infrastructure.monitoring import get_metrics_collector
    ...
    def test_alert_manager_singleton(self):
        from mcp_ultra.infrastructure.monitoring import get_alert_manager
...
class TestConvenienceFunctions:
    ...
    def test_check_health(self):
        from mcp_ultra.infrastructure.monitoring import check_health
    ...
    def test_get_metrics(self):
        from mcp_ultra.infrastructure.monitoring import get_metrics

        metrics = get_metrics()
        assert "request_count" in metrics

    def test_record_metric(self):
        from mcp_ultra.infrastructure.monitoring import get_metrics, record_metric
