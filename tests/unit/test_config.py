...
class TestConfig:
    ...
    def test_config_has_required_sections(self):
        ...
        required_sections = ['blender:', 'assets:', 'security:', 'logging:', 'performance:', 'tools:']
...
class TestSettings:
    ...
    def test_settings_from_dict(self):
        ...
        from infrastructure.config.settings import dict_to_settings
    ...
    def test_env_override(self):
        ...
        from infrastructure.config.settings import apply_env_overrides
        config = {}
