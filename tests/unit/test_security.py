...
class TestSandbox:
    ...
    def test_execute_safe_code(self):
        from mcp_ultra.infrastructure.security.sandbox import Sandbox
...
class TestURLValidator:
    ...
    def test_safe_url(self):
        from mcp_ultra.infrastructure.security.url_validator import URLValidator
    ...
    def test_validate_strict_raises(self):
        from mcp_ultra.infrastructure.security.url_validator import URLError, URLValidator
...
class TestRateLimiter:
    ...
    def test_allows_first_request(self):
        from mcp_ultra.infrastructure.security.rate_limiter import RateLimiter
