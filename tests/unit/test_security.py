...
class TestSandbox:
    ...
    def test_execute_safe_code(self):
        from src.infrastructure.security.sandbox import Sandbox
...
class TestURLValidator:
    ...
    def test_safe_url(self):
        from src.infrastructure.security.url_validator import URLValidator
    ...
    def test_validate_strict_raises(self):
        from src.infrastructure.security.url_validator import URLError, URLValidator
...
class TestInputValidator:
    ...
    def test_blocks_sql_injection(self):
        from src.infrastructure.security.input_validator import InputValidationError, InputValidator
