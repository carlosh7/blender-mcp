...
class TestToolRegistry:
    ...
    def test_register_tool(self):
        ...
        from src.tools.registry import ToolInfo, ToolRegistry
    ...
    def test_list_tools(self):
        ...
        r.register(
            ToolInfo(name="tool1", version="1.0.0", description="", category="cat1", handler="")
        )
        r.register(
            ToolInfo(name="tool2", version="1.0.0", description="", category="cat2", handler="")
        )
    ...
    def test_list_tools_by_category(self):
        ...
        r.register(
            ToolInfo(name="tool2", version="1.0.0", description="", category="cat1", handler="")
        )
        r.register(
            ToolInfo(name="tool3", version="1.0.0", description="", category="cat2", handler="")
        )
