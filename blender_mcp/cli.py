...
def main():
    ...
    parser.add_argument(
        "--mode", choices=["stdio", "sse"], default="stdio", help="Transport mode (default: stdio)"
    )
    parser.add_argument("--port", type=int, default=9879, help="Port for SSE mode (default: 9879)")
    parser.add_argument(
