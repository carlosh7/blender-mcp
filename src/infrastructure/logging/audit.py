...
class AuditLogger:
    ...
    def __init__(
        ...
        handler = RotatingFileHandler(
            self.log_path, maxBytes=self.max_file_size, backupCount=self.backup_count
        )
    ...
    def log_security_violation(
        self, violation_type: str, details: dict[str, Any], user_id: str = None, **kwargs
    ) -> None:
    ...
    def read_logs(
        self, limit: int = 100, event_type: str | None = None, level: LogLevel | None = None
    ) -> list[AuditEvent]:
