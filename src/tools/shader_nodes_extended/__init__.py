...
TOOLS = [
    ...
    Tool(
        "shader.displacement_output",
        ToolCategory.SHADER_NODES,
        "Add displacement output node",
        ToolPermission.WRITE,
        {"material_name": {"type": "str", "required": True}},
    ),
    # Shader Nodes
    ...
    Tool(
        "shader.sss_bsdf",
        ToolCategory.SHADER_NODES,
        "Add subsurface scattering node",
        ToolPermission.WRITE,
        {"material_name": {"type": "str", "required": True}},
    ),
    Tool(
...
HANDLERS = {
    "shader.brick_texture": brick_texture,
    "shader.checker_texture": checker_texture,
    "shader.gradient_texture": gradient_texture,
    "shader.magic_texture": magic_texture,
    "shader.musgrave_texture": musgrave_texture,
    "shader.voronoi_texture": voronoi_texture,
    "shader.wave_texture": wave_texture,
    "shader.white_noise_texture": white_noise_texture,
    "shader.mix_rgb": mix_rgb,
    "shader.rgb_curves": rgb_curves,
    "shader.hue_saturation": hue_saturation,
    "shader.invert": invert,
    "shader.math": math,
    "shader.vector_math": vector_math,
    "shader.mapping": mapping,
    "shader.combine_xyz": combine_xyz,
    "shader.separate_xyz": separate_xyz,
    "shader.texture_coordinate": texture_coordinate,
    "shader.object_info": object_info,
    "shader.geometry": geometry,
    "shader.camera_data": camera_data,
    "shader.fresnel": fresnel,
    "shader.layer_weight": layer_weight,
    "shader.rgb": rgb,
    "shader.value": value,
    "shader.displacement": displacement,
    "shader.normal_map": normal_map,
    "shader.bump": bump,
    "shader.vector_transform": vector_transform,
    "shader.material_output": material_output,
    "shader.displacement_output": displacement_output,
    "shader.add_shader": add_shader,
    "shader.mix_shader": mix_shader,
    "shader.glass_bsdf": glass_bsdf,
    "shader.emission": emission,
    "shader.transparent_bsdf": transparent_bsdf,
    "shader.translucent_bsdf": translucent_bsdf,
    "shader.refraction_bsdf": refraction_bsdf,
    "shader.velvet_bsdf": velvet_bsdf,
    "shader.sss_bsdf": sss_bsdf,
    "shader.toon_bsdf": toon_bsdf,
}
