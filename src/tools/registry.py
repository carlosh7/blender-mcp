...
class ToolRegistry:
    ...
    def get(self, name: str, version: str = None) -> Optional[ToolInfo]:
        """
    ...
    def get_handler(self, name: str, version: str = None) -> Optional[str]:
        """
    ...
    def negotiate_version(self, client_version: str, tool_name: str) -> Optional[str]:
        """
...
def get_tool_info(name: str, version: str = None) -> Optional[ToolInfo]:
    """Get tool info (convenience function)."""
    return get_registry().get(name, version)


def get_tool_handler(name: str, version: str = None) -> Optional[str]:
