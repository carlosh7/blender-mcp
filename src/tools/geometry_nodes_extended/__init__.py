...
TOOLS = [
    ...
    Tool("geonodes.set_position", ToolCategory.GEOMETRY_NODES, "Add set position node", ToolPermission.WRITE,
         {"group_name": {"type": "str", "required": True}}),
    Tool("geonodes.delete_geometry", ToolCategory.GEOMETRY_NODES, "Add delete geometry node", ToolPermission.WRITE,
         {"group_name": {"type": "str", "required": True}}),
...
HANDLERS = {
    ...
    "geonodes.delete_geometry": delete_geometry, "geonodes.duplicate_elements": duplicate_elements,
