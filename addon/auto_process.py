...
- Para código específico no cubierto por tools: usa execute_blender_code con código SIMPLE. No hagas todo en un bloque. Crea un objeto, verifica, luego el siguiente.
