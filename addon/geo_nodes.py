...
def create_parametric_table(
    width=1.2, depth=0.8, height=0.75, leg_style="straight", material="PBR_Oak_100"
):
    """
...
def create_roof(width=10, depth=8, height=3, style="gabled"):
    ...
    if style == "gabled":
        ...
        bpy.ops.mesh.primitive_cone_add(
            radius1=width / 2, radius2=0, depth=height, vertices=4, location=(0, 0, height / 2)
        )
        roof = bpy.context.active_object
        roof.name = "Roof_Hip"
