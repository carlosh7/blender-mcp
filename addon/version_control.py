...
class VersionControl:
    ...
    def create_version(self, label: str | None = None) -> str:
        """
    ...
    def _compute_hash(self, filepath: Path) -> str:
        """Calcular hash MD5 de un archivo (solo integridad, no criptografía)."""
...
def create_snapshot(label: str | None = None) -> str:
