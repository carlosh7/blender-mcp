...
def reset_scene_transforms(objects: Optional[List[bpy.types.Object]] = None) -> Dict[str, any]:
    """
...
def apply_scene_transforms(objects: Optional[List[bpy.types.Object]] = None) -> Dict[str, any]:
    """
...
def get_transform_status(obj: bpy.types.Object) -> Dict[str, any]:
    ...
    return {
        ...
        "origin_offset": list(obj.data.vertices[0].co) if obj.type == 'MESH' and obj.data.vertices else None,
    }
