...
TOOLS = [
    {
        "name": "get_scene_info",
        "description": "Get scene info (objects, counts)",
    ...
    {
        "name": "create_object",
        "description": "Create mesh object",
        "inputSchema": {
            "type": "object",
            "properties": {
                "type": {
    ...
    },
    {
        ...
        "description": "Move/rotate/scale object",
        "inputSchema": {
            "type": "object",
            "properties": {
                "name": {"type": "string"},
    ...
    },
    {
        ...
        "description": "Create PBR material",
        "inputSchema": {
            "type": "object",
            "properties": {
                "name": {"type": "string"},
    ...
    },
    {
        ...
        "inputSchema": {
            "type": "object",
            "properties": {"object_name": {"type": "string"}, "material_name": {"type": "string"}},
    ...
    },
    {
        ...
        "description": "Auto 3-point lighting",
        "inputSchema": {"type": "object", "properties": {}},
    },
    {
        "name": "create_camera",
    ...
    },
    {
        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "format": {
                    "type": "string",
                    "enum": ["glb", "gltf", "fbx", "obj", "stl", "ply", "usd", "dae"],
                },
            },
    ...
    },
    {
        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "method": {
                    "type": "string",
                    "enum": ["smart", "unwrap", "cube", "cylinder", "sphere"],
                },
            },
        },
    },
    ...
    },
    {
        ...
        "inputSchema": {
            "type": "object",
            "properties": {"engine": {"type": "string", "enum": ["CYCLES", "EEVEE", "WORKBENCH"]}},
        },
    },
    {
        "name": "check_manifold",
        "description": "Check if mesh is watertight",
        "inputSchema": {"type": "object", "properties": {"object_name": {"type": "string"}}},
    },
    {
        "name": "export_stl_mm",
        "description": "Export STL in mm for 3D printing",
        "inputSchema": {
            "type": "object",
            "properties": {"filepath": {"type": "string"}, "object_name": {"type": "string"}},
            "required": ["filepath"],
        },
    },
    {
    ...
    },
    {
        ...
        "description": "Download PBR texture",
        "inputSchema": {
            "type": "object",
            "properties": {"asset_id": {"type": "string"}},
            "required": ["asset_id"],
    ...
    },
    {
        ...
        "description": "ASCII spatial visualization",
        "inputSchema": {"type": "object", "properties": {}},
    },
    {
        "name": "mesh_analysis",
        "description": "Analyze mesh topology",
        "inputSchema": {"type": "object", "properties": {"object_name": {"type": "string"}}},
    },
    {
        "name": "purge_orphans",
    ...
    {
        "name": "scene_summary",
        "description": "Full scene summary",
        "inputSchema": {"type": "object", "properties": {}},
    },
]
    ...
    if method == "initialize":
        return {
            ...
            "result": {
                ...
                "capabilities": {"tools": {}},
                "serverInfo": {"name": "blender-mcp", "version": "0.8.64"},
            },
        }
        ...
        cmd_map = {
            ...
            "transform_object": (
                "transform_object",
                {"name": arguments.get("name", ""), "location": arguments.get("location")},
            ),
