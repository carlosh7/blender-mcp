...
def create_organic_blob(radius: float = 1.0, detail: int = 3) -> bpy.types.Object | None:
    """
    ...
    try:
        ...
        bpy.ops.mesh.primitive_uv_sphere_add(
            radius=radius, segments=32, ring_count=16, location=(0, 0, 0)
        )
...
def create_rock(radius: float = 0.5, roughness: float = 0.3) -> bpy.types.Object | None:
    """
