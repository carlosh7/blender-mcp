...
def test_core_entities():
    ...
    from core.entities import Material, Object, Scene, Tool, ToolCategory, ToolPermission
...
def test_scene_tools():
    ...
    from tools.scene import HANDLERS, TOOLS
...
def test_object_tools():
    ...
    from tools.objects import HANDLERS, TOOLS
...
def test_material_tools():
    ...
    from tools.materials import HANDLERS, TOOLS
...
def test_light_tools():
    ...
    from tools.lights import HANDLERS, TOOLS
...
def test_modifier_tools():
    ...
    from tools.modifiers import HANDLERS, TOOLS
...
def test_animation_tools():
    ...
    from tools.animation import HANDLERS, TOOLS
...
def test_camera_tools():
    ...
    print("=" * 60)
    from tools.camera import HANDLERS, TOOLS
...
def test_render_tools():
    ...
    print("=" * 60)
    from tools.render import HANDLERS, TOOLS
...
def test_io_tools():
    ...
    print("=" * 60)
    from tools.io import HANDLERS, TOOLS
...
def test_uv_texture_tools():
    ...
    print("=" * 60)
    from tools.uv_texture import HANDLERS, TOOLS
...
def test_rigging_tools():
    ...
    print("=" * 60)
    from tools.rigging import HANDLERS, TOOLS
...
def test_batch_tools():
    ...
    print("=" * 60)
    from tools.batch import HANDLERS, TOOLS
...
def test_scene_utils_tools():
    ...
    print("=" * 60)
    from tools.scene_utils import HANDLERS, TOOLS
...
def test_printing_tools():
    ...
    print("=" * 60)
    from tools.printing import HANDLERS, TOOLS
...
def test_shader_node_tools():
    ...
    print("=" * 60)
    from tools.shader_nodes import HANDLERS, TOOLS
...
def test_geonode_tools():
    ...
    print("=" * 60)
    from tools.geometry_nodes import HANDLERS, TOOLS
...
def test_infrastructure():
    ...
    print("\n3. Connection Pool...")
    from infrastructure.network import ConnectionConfig, ConnectionPool

    ConnectionPool(ConnectionConfig(), max_connections=2)
