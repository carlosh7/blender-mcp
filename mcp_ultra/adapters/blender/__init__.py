...
from ...core.entities import Material, Object, Scene, ToolResult
...
class BlenderAdapter(IBlenderAPI):
    ...
    def execute_code(self, code: str) -> ToolResult:
        ...
        if not self._connected:
            return ToolResult(success=False, error="Not connected to Blender")
...
"""
    ...
    def get_viewport_screenshot(self) -> ToolResult:
        ...
        filepath = os.path.join(
            tempfile.gettempdir(), f"blender_mcp_screenshot_{int(time.time())}.png"
        )
