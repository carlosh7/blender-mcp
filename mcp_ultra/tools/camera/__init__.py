...
TOOLS = [
    Tool(
        ...
        {
            "name": {"type": "str"},
            "location": {"type": "tuple", "default": (0, -5, 2)},
...
def list_cameras() -> dict:
    try:
        ...
        cameras = [
            {"name": o.name, "lens": o.data.lens, "location": list(o.location)}
...
HANDLERS = {
    ...
    "camera.set_active": set_active,
    "camera.update": update,
    "camera.track_to": track_to,
    "camera.list": list_cameras,
    "camera.setResolution": set_resolution,
    "camera.set_framing": set_framing,
}
