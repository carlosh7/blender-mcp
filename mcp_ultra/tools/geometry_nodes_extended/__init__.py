...
TOOLS = [
    ...
    Tool(
        "geonodes.mesh_circle",
        ToolCategory.GEOMETRY_NODES,
        "Add mesh circle node",
        ToolPermission.WRITE,
    ...
    Tool(
        "geonodes.mesh_ico_sphere",
        ToolCategory.GEOMETRY_NODES,
        "Add mesh ico sphere node",
        ToolPermission.WRITE,
        {"group_name": {"type": "str", "required": True}, "radius": {"type": "float"}},
    ),
    Tool(
        "geonodes.mesh_uv_sphere",
        ToolCategory.GEOMETRY_NODES,
        "Add mesh UV sphere node",
        ToolPermission.WRITE,
        {"group_name": {"type": "str", "required": True}, "radius": {"type": "float"}},
    ),
    Tool(
    ...
    Tool(
        "geonodes.mesh_cylinder",
        ToolCategory.GEOMETRY_NODES,
        "Add mesh cylinder node",
        ToolPermission.WRITE,
        {"group_name": {"type": "str", "required": True}, "radius": {"type": "float"}},
    ),
    Tool(
    ...
    Tool(
        "geonodes.curve_circle",
        ToolCategory.GEOMETRY_NODES,
        "Add curve circle node",
        ToolPermission.WRITE,
        {"group_name": {"type": "str", "required": True}, "radius": {"type": "float"}},
    ),
    Tool(
        "geonodes.curve_quadratic_bezier",
        ToolCategory.GEOMETRY_NODES,
        "Add curve quadratic bezier node",
        ToolPermission.WRITE,
        {"group_name": {"type": "str", "required": True}},
    ),
    Tool(
        "geonodes.curve_cubic_bezier",
        ToolCategory.GEOMETRY_NODES,
        "Add curve cubic bezier node",
        ToolPermission.WRITE,
        {"group_name": {"type": "str", "required": True}},
    ),
    Tool(
        "geonodes.curve_spiral",
        ToolCategory.GEOMETRY_NODES,
        "Add curve spiral node",
        ToolPermission.WRITE,
        {"group_name": {"type": "str", "required": True}},
    ),
    Tool(
    ...
    Tool(
        "geonodes.curve_quadrilateral",
        ToolCategory.GEOMETRY_NODES,
        "Add curve quadrilateral node",
        ToolPermission.WRITE,
        {"group_name": {"type": "str", "required": True}},
    ),
    # Geometry Operations
    Tool(
        "geonodes.transform_geometry",
        ToolCategory.GEOMETRY_NODES,
    ...
    Tool(
        ...
        ToolCategory.GEOMETRY_NODES,
        "Add delete geometry node",
        ToolPermission.WRITE,
        {"group_name": {"type": "str", "required": True}},
    ),
    Tool(
        "geonodes.duplicate_elements",
        ToolCategory.GEOMETRY_NODES,
        "Add duplicate elements node",
        ToolPermission.WRITE,
        {"group_name": {"type": "str", "required": True}},
    ),
    Tool(
        "geonodes.realize_instances",
        ToolCategory.GEOMETRY_NODES,
    ...
    Tool(
        "geonodes.merge_by_distance",
        ToolCategory.GEOMETRY_NODES,
        "Add merge by distance node",
        ToolPermission.WRITE,
        {"group_name": {"type": "str", "required": True}, "distance": {"type": "float"}},
    ),
    Tool(
        "geonodes.subdivide_mesh",
        ToolCategory.GEOMETRY_NODES,
    ...
    Tool(
        "geonodes.triangulate_mesh",
        ToolCategory.GEOMETRY_NODES,
        "Add triangulate mesh node",
        ToolPermission.WRITE,
        {"group_name": {"type": "str", "required": True}},
    ),
    Tool(
    ...
    Tool(
        "geonodes.scale_elements",
        ToolCategory.GEOMETRY_NODES,
        "Add scale elements node",
        ToolPermission.WRITE,
        {"group_name": {"type": "str", "required": True}},
    ),
    Tool(
    ...
    Tool(
        "geonodes.bmesh_to_mesh",
        ToolCategory.GEOMETRY_NODES,
        "Add BMesh to mesh node",
        ToolPermission.WRITE,
        {"group_name": {"type": "str", "required": True}},
    ),
    Tool(
        "geonodes.mesh_to_bmesh",
        ToolCategory.GEOMETRY_NODES,
        "Add mesh to BMesh node",
        ToolPermission.WRITE,
        {"group_name": {"type": "str", "required": True}},
    ),
    # Curve Operations
    Tool(
        "geonodes.curve_to_mesh",
        ToolCategory.GEOMETRY_NODES,
        "Add curve to mesh node",
        ToolPermission.WRITE,
        {"group_name": {"type": "str", "required": True}},
    ),
    Tool(
        "geonodes.mesh_to_curve",
        ToolCategory.GEOMETRY_NODES,
    ...
    Tool(
        "geonodes.fillet_curve",
        ToolCategory.GEOMETRY_NODES,
        "Add fillet curve node",
        ToolPermission.WRITE,
        {"group_name": {"type": "str", "required": True}, "count": {"type": "int"}},
    ),
    Tool(
        "geonodes.reverse_curve",
        ToolCategory.GEOMETRY_NODES,
        "Add reverse curve node",
        ToolPermission.WRITE,
        {"group_name": {"type": "str", "required": True}},
    ),
    Tool(
        "geonodes.set_curve_radius",
        ToolCategory.GEOMETRY_NODES,
    ...
    Tool(
        "geonodes.set_curve_tilt",
        ToolCategory.GEOMETRY_NODES,
        "Add set curve tilt node",
        ToolPermission.WRITE,
        {"group_name": {"type": "str", "required": True}},
    ),
    Tool(
        "geonodes.spline_to_bezier",
        ToolCategory.GEOMETRY_NODES,
        "Add spline to bezier node",
        ToolPermission.WRITE,
        {"group_name": {"type": "str", "required": True}},
    ),
    Tool(
        "geonodes.string_to_curve",
        ToolCategory.GEOMETRY_NODES,
        "Add string to curve node",
        ToolPermission.WRITE,
        {"group_name": {"type": "str", "required": True}},
    ),
    # Instance Operations
    Tool(
        "geonodes.instance_on_points",
        ToolCategory.GEOMETRY_NODES,
    ...
    Tool(
        "geonodes.translate_instances",
        ToolCategory.GEOMETRY_NODES,
        "Add translate instances node",
        ToolPermission.WRITE,
        {"group_name": {"type": "str", "required": True}},
    ),
    Tool(
    ...
    Tool(
        "geonodes.pick_instances",
        ToolCategory.GEOMETRY_NODES,
        "Add pick instances node",
        ToolPermission.WRITE,
        {"group_name": {"type": "str", "required": True}},
    ),
    # Attribute Operations
    Tool(
        "geonodes.capture_attribute",
        ToolCategory.GEOMETRY_NODES,
        "Add capture attribute node",
        ToolPermission.WRITE,
        {"group_name": {"type": "str", "required": True}},
    ),
    Tool(
        "geonodes.store_named_attribute",
        ToolCategory.GEOMETRY_NODES,
    ...
    Tool(
        "geonodes.remove_named_attribute",
        ToolCategory.GEOMETRY_NODES,
        "Add remove named attribute node",
        ToolPermission.WRITE,
        {"group_name": {"type": "str", "required": True}, "name": {"type": "str"}},
    ),
    Tool(
        "geonodes.blur_attribute",
        ToolCategory.GEOMETRY_NODES,
        "Add blur attribute node",
        ToolPermission.WRITE,
        {"group_name": {"type": "str", "required": True}},
    ),
    Tool(
        "geonodes.attribute_statistic",
        ToolCategory.GEOMETRY_NODES,
        "Add attribute statistic node",
        ToolPermission.WRITE,
        {"group_name": {"type": "str", "required": True}},
    ),
    Tool(
        "geonodes.domain_size",
        ToolCategory.GEOMETRY_NODES,
        "Add domain size node",
        ToolPermission.WRITE,
        {"group_name": {"type": "str", "required": True}},
    ),
    Tool(
        "geonodes.transfer_attribute",
        ToolCategory.GEOMETRY_NODES,
        "Add transfer attribute node",
        ToolPermission.WRITE,
        {"group_name": {"type": "str", "required": True}},
    ),
    # Simulation
    Tool(
        "geonodes.simulation_zone",
        ToolCategory.GEOMETRY_NODES,
        "Add simulation zone",
        ToolPermission.WRITE,
        {"group_name": {"type": "str", "required": True}},
    ...
    Tool(
        "geonodes.accumulate_field",
        ToolCategory.GEOMETRY_NODES,
        "Add accumulate field node",
        ToolPermission.WRITE,
        {"group_name": {"type": "str", "required": True}},
    ),
    Tool(
    ...
    Tool(
        "geonodes.edge_neighbors",
        ToolCategory.GEOMETRY_NODES,
        "Add edge neighbors node",
        ToolPermission.WRITE,
        {"group_name": {"type": "str", "required": True}},
    ),
]
...
HANDLERS = {
    "geonodes.mesh_cube": mesh_cube,
    "geonodes.mesh_circle": mesh_circle,
    "geonodes.mesh_line": mesh_line,
    "geonodes.mesh_grid": mesh_grid,
    "geonodes.mesh_ico_sphere": mesh_ico_sphere,
    "geonodes.mesh_uv_sphere": mesh_uv_sphere,
    "geonodes.mesh_cone": mesh_cone,
    "geonodes.mesh_cylinder": mesh_cylinder,
    "geonodes.mesh_torus": mesh_torus,
    "geonodes.curve_line": curve_line,
    "geonodes.curve_circle": curve_circle,
    "geonodes.curve_quadratic_bezier": curve_quadratic_bezier,
    "geonodes.curve_cubic_bezier": curve_cubic_bezier,
    "geonodes.curve_spiral": curve_spiral,
    "geonodes.curve_star": curve_star,
    "geonodes.curve_quadrilateral": curve_quadrilateral,
    "geonodes.transform_geometry": transform_geometry,
    "geonodes.set_position": set_position,
    "geonodes.delete_geometry": delete_geometry,
    "geonodes.duplicate_elements": duplicate_elements,
    "geonodes.realize_instances": realize_instances,
    "geonodes.merge_by_distance": merge_by_distance,
    "geonodes.subdivide_mesh": subdivide_mesh,
    "geonodes.triangulate_mesh": triangulate_mesh,
    "geonodes.dual_mesh": dual_mesh,
    "geonodes.scale_elements": scale_elements,
    "geonodes.raycast": raycast,
    "geonodes.convex_hull": convex_hull,
    "geonodes.bounding_box": bounding_box,
    "geonodes.bmesh_to_mesh": bmesh_to_mesh,
    "geonodes.mesh_to_bmesh": mesh_to_bmesh,
    "geonodes.curve_to_mesh": curve_to_mesh,
    "geonodes.mesh_to_curve": mesh_to_curve,
    "geonodes.curve_to_points": curve_to_points,
    "geonodes.resample_curve": resample_curve,
    "geonodes.fill_curve": fill_curve,
    "geonodes.fillet_curve": fillet_curve,
    "geonodes.reverse_curve": reverse_curve,
    "geonodes.set_curve_radius": set_curve_radius,
    "geonodes.set_curve_tilt": set_curve_tilt,
    "geonodes.spline_to_bezier": spline_to_bezier,
    "geonodes.string_to_curve": string_to_curve,
    "geonodes.instance_on_points": instance_on_points,
    "geonodes.on_points": on_points,
    "geonodes.rotate_instances": rotate_instances,
    "geonodes.scale_instances": scale_instances,
    "geonodes.translate_instances": translate_instances,
    "geonodes.pick_instances": pick_instances,
    "geonodes.capture_attribute": capture_attribute,
    "geonodes.store_named_attribute": store_named_attribute,
    "geonodes.remove_named_attribute": remove_named_attribute,
    "geonodes.blur_attribute": blur_attribute,
    "geonodes.attribute_statistic": attribute_statistic,
    "geonodes.domain_size": domain_size,
    "geonodes.transfer_attribute": transfer_attribute,
    "geonodes.simulation_zone": simulation_zone,
    "geonodes.simulation_input": simulation_input,
    "geonodes.simulation_output": simulation_output,
    "geonodes.math": math_node,
    "geonodes.compare": compare,
    "geonodes.boolean": boolean,
    "geonodes.random_value": random_value,
    "geonodes.accumulate_field": accumulate_field,
    "geonodes.index": index,
    "geonodes.position": position,
    "geonodes.normal": normal,
    "geonodes.face_area": face_area,
    "geonodes.edge_neighbors": edge_neighbors,
}
