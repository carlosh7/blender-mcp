...
def test_url_validator():
    ...
    from infrastructure.security.url_validator import URLError, URLValidator
...
def test_input_validator():
    ...
    from infrastructure.security.input_validator import InputValidationError, InputValidator
