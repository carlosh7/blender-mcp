...
- **15+ Skills** for Claude Code/Cursor
...
15 specialized skills for Claude Code/Cursor:
...
- **AST Validation**: Blocks dangerous code patterns
- **Sandboxed Execution**: Isolated namespace
